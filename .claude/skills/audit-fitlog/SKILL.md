...
2. **Data correctness:** invalid numeric coercion, dates/time zone, units, duplicate-day behavior, macro calorie consistency, progression boundaries, and destructive writes.
