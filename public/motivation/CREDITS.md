# Motivation image credits

Photographs from Unsplash, used under the Unsplash License, which permits
free commercial and non-commercial use without permission or attribution.
Credited here anyway.

- `gym-floor.jpg` — Andrii Solok (unsplash.com/photos/3WSidr2Yqkc) — Dark gym interior with exercise equipment visible
